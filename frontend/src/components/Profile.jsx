...
const Profile = () => {
    ...
    return (
        <div>
            <Navbar />
            <div className='max-w-4xl mx-auto bg-white border border-gra-200 rounded-2xl my-5 p-8'>
                <div className='flex justify-between'>
                    <div className='flex items-center gap-4'>
                        <Avatar className="h-24 w-24">
                            <AvatarImage src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQq5RkOAUkCkCm3lBpxDcTRc8gJF0yhBpHmhA&s" alt="profile_logo" />
                        </Avatar>
                        <div>
