    ...
    return (
        <div className='max-w-7xl my-10 mx-auto'>
            <div className='flex items-center justify-between'>
                ...
                <Button onClick={applyJobHandler} disabled={isApplied} className={`rounded-lg ${isApplied ? 'bg-gray-600 cursor-not-allowed' : 'bg-[#7209b7] hover:bg-[#5f32ad]'}`}>{isApplied ? 'Already Applied' : 'Apply Now'}</Button>
            </div>
            <div>
